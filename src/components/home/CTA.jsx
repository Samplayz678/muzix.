      ...
      <div className="sticky top-0 h-screen w-full flex flex-col items-center justify-center overflow-hidden" style={{ perspective: "1000px" }}>
        ...
        >
          <motion.div
            ...
            className="glass-panel p-16 md:p-24 rounded-[3.5rem] bg-gradient-to-br from-accent-primary/20 via-transparent to-transparent relative overflow-hidden shadow-[0_0_50px_rgba(239,68,68,0.15)]"
          >
            {/* Background Glow */}
            ...
            <div className="flex flex-wrap justify-center gap-6">
              <motion.a 
                ...
                className="flex items-center gap-2 px-12 py-5 bg-white text-black font-black text-xl rounded-2xl shadow-xl shadow-white/10"
              >
                <Link size={24} />
              ...
              <motion.a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 px-12 py-5 bg-white/5 border border-white/10 text-white font-black text-xl rounded-2xl hover:bg-white/10 transition-colors"
              >
